...
write.csv(ptm_class_overview,
          "results/tables/step3_ptm_class_overview.csv",
          row.names = FALSE)
...
ggsave("results/figures/step3_heatmap_proteins_per_ptmclass.png",
       p_heatmap_proteins,
...
ggsave("results/figures/step3_heatmap_fc_per_ptmclass.png",
       p_heatmap_fc,
       width = 10, height = 7, dpi = 300)
...
ggsave("results/figures/step3_bar_proteins_key_comparisons.png",
       p_bar_proteins,
       width = 10, height = 7, dpi = 300)
...
write.csv(poi_ptm_coverage,
          "results/tables/step3_poi_ptm_coverage.csv",
          row.names = FALSE)
...
for (comp in key_comparisons) {
  ...
  ggsave(paste0("results/figures/step3_volcano_", fname, ".png"),
         p_vol,
...
write.csv(poi_detail,
          "results/tables/step3_poi_ptm_detail.csv",
          row.names = FALSE)
...
write.csv(poi_presence,
          "results/tables/step3_poi_presence_summary2.csv",
          row.names = FALSE)
...
write.csv(selection_justification,
          "results/tables/step3_ptm_selection_justification.csv",
          row.names = FALSE)
