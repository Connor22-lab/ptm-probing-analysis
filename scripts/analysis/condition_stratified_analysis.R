...
# I/O
# -------------------------
ptm_file     <- "data/processed/PTM1_biological_corrected.csv"
protein_file <- "data/processed/protein_da_corrected.csv"
...
write.csv(ptm_class_rank, "results/tables/ptm_class_rank.csv", row.names = FALSE)
...
write.csv(protein_hotspots, "results/tables/protein_hotspots.csv", row.names = FALSE)
...
write.csv(poi_summary, "results/tables/poi_composite_summary.csv", row.names = FALSE)
