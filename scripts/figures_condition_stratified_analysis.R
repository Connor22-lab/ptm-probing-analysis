...
#   3) data_processed/PTM1_final_corrected.csv  (site-level corrected dataset)
#
# Outputs (PNG):
...
# Files + thresholds
# -------------------------
ptm_rank_file   <- "tables/ptm_class_rank.csv"
hotspots_file   <- "tables/protein_hotspots.csv"
ptm_final_file  <- "data_processed/PTM1_final_corrected.csv"
...
ggsave("figures/Fig1_PTM_class_prioritisation_bubble.png",
...
ggsave("figures/Fig2_Protein_hotspots_bar.png",
...
ggsave("figures/Fig3_PTMxComparison_fraction_robust_heatmap.png",
