...
# === PATHS ===
ptm_file <- "data_processed/ptm_closed_search_corrected.tsv"
protein_file <- "data_processed/ptm_closed_search_corrected_PG_candidates.tsv"
output_dir <- "figures/closed_search"
