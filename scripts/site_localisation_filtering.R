...
write.csv(filter_summary,
          "tables/step2_filtering_summary.csv",
          row.names = FALSE)
...
ggsave("figures/step2_filter_waterfall.png", p_waterfall,
...
write.csv(mod_survival,
          "tables/step2_modification_survival_summary.csv",
          row.names = FALSE)

# --- 8. Export filtered datasets ---
write.csv(ptm_standard,
          "data_processed/PTM1_filtered_standard.csv",
          row.names = FALSE)

write.csv(ptm_highconf,
          "data_processed/PTM1_filtered_highconf.csv",
          row.names = FALSE)
...
write.csv(mod_bio_summary,
          "tables/step2_biological_ptm_summary.csv",
          row.names = FALSE)

write.csv(ptm_biological,
          "data_processed/PTM1_biological.csv",
          row.names = FALSE)
