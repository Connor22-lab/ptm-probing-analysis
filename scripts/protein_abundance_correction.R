...
# Inputs:
#   data_processed/PTM1_biological_corrected.csv
#   data_processed/protein_da_corrected.csv
# =============================================================
rm(list = ls())
library(dplyr)
library(data.table)
...
write.csv(selection_corrected,
          "tables/step3_ptm_selection_corrected.csv",
          row.names = FALSE)
...
write.csv(poi_corrected,
          "tables/step3_poi_corrected.csv",
          row.names = FALSE)

# --- 7. Export ---
write.csv(ptm_corrected,
          "data_processed/PTM1_abundance_corrected.csv",
          row.names = FALSE)
